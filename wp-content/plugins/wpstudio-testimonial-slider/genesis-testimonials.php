...
function wpstudio_gts_activation_check() {
	...
	if ( ! function_exists( 'genesis_pre' ) ) {
		...
		wp_die( sprintf( __( 'Sorry, you can\'t activate %1$sGenesis Slide-in Widget unless you have installed the %3$sGenesis Framework%4$s. Go back to the %5$sPlugins Page%4$s.', 'wpstudio-testimonial-slider' ), '<em>', '</em>', '<a href="http://www.studiopress.com/themes/genesis" target="_blank">', '</a>', '<a href="javascript:history.back()">' ) );
	}
	...
	if ( version_compare( $theme_info['Version'], $latest, '<' ) ) {
		...
		wp_die( sprintf( __( 'Sorry, you can\'t activate %1$sGenesis Slide-in Widget unless you have installed the %3$sGenesis %4$s%5$s. Go back to the %6$sPlugins Page%5$s.', 'wpstudio-testimonial-slider' ), '<em>', '</em>', '<a href="http://www.studiopress.com/themes/genesis" target="_blank">', $latest, '</a>', '<a href="javascript:history.back()">' ) );
...
add_action( 'after_switch_theme', 'wpstudio_gts_deactivate_check', 10 );
